...
// 다중 구현
// public class 클래스명 implements 인터페이스A, 인터페이스{ }
public class SmartTelevision implements SmartRemoteControl, Searchable {
	...
	public String[] contentSearch(String keyword) {
		String[] movieContents = {"윙카", "서울의봄", "인셉션", "인터스텔라","타짜" };
		String[] idolContens = {"뉴진스", "투모로우바이투게더", "피프티피프티", "BTS"};
