...
public class StudnetEx {
	...
	public static void main(String[] args) {
		...
		// student 의 변수에 접근하여, name age, stdNo, major 값을지정해보세요.
		student.name = "가나다";
		student.age = 20;
		...
		System.out.println("학생1 - 중간고사 점수 : " + student.getAvergage( 100, 90));
		System.out.println("학생1 - 기말고사 점수 : " + student.getAvergage( 100, 85, 70));
		System.out.println("학생1 - 최종 점수 : " + student.getAvergage( scores ));
		...
		// - 학번 : T100200
		// - 전공 : 내전공
		Student student2 = new Student("백승헌", 20,	"T202012", "영어문학과");
		int socre2[] = {55, 80,60, 35, 90};
		System.out.println(" 학생 2 : 백승헌 ");
		...
		student.study("음운론");
		System.out.println("학생2 - 중간고사 점수 : " + student2.getAvergage( 100, 90));
		System.out.println("학생2 - 기말고사 점수 : " + student2.getAvergage( 100, 85, 70));
		System.out.println("학생2 - 최종 점수 : " + student.getAvergage( socre2 ));
	}
}
